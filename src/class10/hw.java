...
public class hw {
    public static void main(String[] args) {
        ...
        if(choose1.equalsIgnoreCase("Appetizer")||choose1.equals("1")) {
            ...
            else System.out.println("Invalid appetizer choice");
        }
            ...
            else System.out.println("Invalid main course choice");
        }
        else if (choose1.equalsIgnoreCase("Drinks")||choose1.equals("3")) {
